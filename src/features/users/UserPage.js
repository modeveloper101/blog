...
const UserPage = () => {
  ...
  const postTiles = postForUser.map((post, index) => (
    ...
    <article key={post.id} className="">
      <img
        src={
          "https://images.unsplash.com/photo-1629198716082-b92910910a59?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
        alt="blog-post"
