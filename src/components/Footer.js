...
const Footer = () => {
  return (
    <div className="flex flex-col items-center text-center h-auto bg-[#010101] text-[#E6E4E0] px-5 pb-[1rem]">
         <div className="flex items-center p-1 gap-x-2 bg-[#E6E4E0] text-[#010101] w-full h-[60px] my-[3rem]">
